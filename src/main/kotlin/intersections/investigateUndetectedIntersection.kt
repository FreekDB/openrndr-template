...
fun isec(s0: Segment, s1: Segment): List<Vector2> {
    val a1 = s0.start
    val a2 = s0.control[0]
    val a3 = s0.control[1]
    val a4 = s0.end
    ...
    val c13 = -a1 + a2 * 3.0 - a3 * 3.0 + a4
    val c12 = a1 * 3.0 - a2 * 6.0 + a3 * 3.0
    val c11 = -a1 * 3.0 + a2 * 3.0
    val c10 = a1

    val c23 = -b1 * 1.0 + b2 * 3.0 - b3 * 3.0 + b4
    val c22 = b1 * 3.0 - b2 * 6.0 + b3 * 3.0
    val c21 = -b1 * 3.0 + b2 * 3.0
    val c20 = b1

    val c10x2 = c10.x * c10.x
    val c10x3 = c10.x * c10.x * c10.x
    val c10y2 = c10.y * c10.y
    val c10y3 = c10.y * c10.y * c10.y
    val c11x2 = c11.x * c11.x
    val c11x3 = c11.x * c11.x * c11.x
    val c11y2 = c11.y * c11.y
    val c11y3 = c11.y * c11.y * c11.y
    val c12x2 = c12.x * c12.x
    val c12x3 = c12.x * c12.x * c12.x
    val c12y2 = c12.y * c12.y
    val c12y3 = c12.y * c12.y * c12.y
    val c13x2 = c13.x * c13.x
    val c13x3 = c13.x * c13.x * c13.x
    val c13y2 = c13.y * c13.y
    val c13y3 = c13.y * c13.y * c13.y
    val c20x2 = c20.x * c20.x
    val c20x3 = c20.x * c20.x * c20.x
    val c20y2 = c20.y * c20.y
    val c20y3 = c20.y * c20.y * c20.y
    val c21x2 = c21.x * c21.x
    val c21x3 = c21.x * c21.x * c21.x
    val c21y2 = c21.y * c21.y
    val c22x2 = c22.x * c22.x
    val c22x3 = c22.x * c22.x * c22.x
    val c22y2 = c22.y * c22.y
    val c23x2 = c23.x * c23.x
    val c23x3 = c23.x * c23.x * c23.x
    val c23y2 = c23.y * c23.y
    val c23y3 = c23.y * c23.y * c23.y
    ...
    val roots = poly.getRootsInInterval(0.0, 1.0)
    ...
    for (s in roots) {
        ...
        if (xRoots.isNotEmpty() && yRoots.isNotEmpty()) {
            checkRoots@
            for (xRoot in xRoots) {
                if (xRoot in 0.0..1.0) {
                    for (yRoot in yRoots) {
                        if (abs(xRoot - yRoot) < 1e-4) {
                            result.add(c23 * s * s * s + c22 * s * s + c21 * s + c20)
                            break@checkRoots
                        }
                    }
                }
...
private fun List<Double>.getRootsInInterval(
    min: Double,
    max: Double
): List<Double> {
    return listOf()
